...
class Enemy(GameSprite) :
    direction = "left"
    def __init__(self, enemy_image, enemy_x, enemy_y, size_x, size_y, enemy_speed, min_x, max_x):
        # Викликаємо конструктор класу (Sprite):
...
w1 = GameSprite('platform.png', 175, 100, 50, 400)
w2 = GameSprite('platform.png', 175, 100, 250, 50)
w3 = GameSprite('platform.png', 550, 0, 50, 350)
w4 = GameSprite('platform.png', 350, 350, 250, 50)
...
#створюємо спрайти
player = Player('player.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('Asset 28@4x.png',615, 0, 80, 80)

monster1 = Enemy('enemy.png', 80, 0, 80, 80, 2, 50, 450)
monster2 = Enemy('enemy.png', 200, 400, 80, 80, 2, 250, 600)
